...
import { LayoutDashboard, Users, Sparkles, MapPin, Calendar, ClipboardList, LogOut, Crown } from 'lucide-react';
    ...
    <aside className="w-64 bg-white border-r border-gray-100 flex flex-col h-screen sticky top-0">
      ...
      <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
        ...
        <div className="pt-4 pb-2 px-3">
          ...
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mt-4 mb-2">Organizer</p>
        </div>
